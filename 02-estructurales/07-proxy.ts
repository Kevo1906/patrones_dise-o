...
class MagicPortal implements Room {
  ...
  enter(player: Player): void {
    ...
    console.log(
      `%cLo siento mucho ${player.name}, tu nivel ${player.level}, es muy baja, necesitas nivel 10`,
      COLORS.red
    );
  }
}
...
function main(){
    ...
    const player1 = new Player('Guerrero A',5)
    const player2 = new Player('Guerrero B',15)
